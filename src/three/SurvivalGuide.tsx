  ...
  return (
    ...
    >
      ...
      <mesh position={[0, 0, 0]}>
        ...
        <meshStandardMaterial color={theme.scene.bookCover} />
      </mesh>
      ...
      <group position={[0, 0, 0.002]}>
        <mesh>
          <boxGeometry args={[0.095, 0.145, 0.001]} />
          <meshStandardMaterial color={theme.scene.bookPages} />
        </mesh>
              ...
              {coverText && (
                <>
                  <Text
                    position={[0, 0.08, 0]}
                    fontSize={0.05}
                    color={coverText.titleColor ?? theme.colors.textWhite}
                    anchorX='center'
                    anchorY='middle'
                    maxWidth={0.18}
                    textAlign='center'
                    fontWeight='bold'
                    font={BungeeFont}
                    outlineColor={theme.colors.textBlack}
                    outlineWidth={0.0075}
                  >
                    {coverText.title}
                  </Text>
                  {coverText.subtitle && (
                    <Text
                      position={[0, -0.1, 0]}
                      fontSize={0.04}
                      color={coverText.subtitleColor ?? theme.colors.textWhite}
                      anchorX='center'
                      anchorY='middle'
                      maxWidth={0.18}
                      textAlign='center'
      ...
      <mesh position={[-0.05, 0.05, 0.0015]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color={theme.scene.binderRings} metalness={0.8} roughness={0.2} />
      </mesh>
